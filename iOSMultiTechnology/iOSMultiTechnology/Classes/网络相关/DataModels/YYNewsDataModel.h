...
@class YYNewsSubDataModel;
@interface YYNewsDataModel : NSObject

@property (nonatomic, assign) NSInteger stat;

@property (nonatomic, strong) NSArray <YYNewsSubDataModel*>*newsLists;

@end
@interface YYNewsSubDataModel : NSObject
